---
title: '5. Azure API Center for MCP discovery'
layout: default
nav_order: 5
...
1. In your API Center instance, select **Inventory** -> **Asset** from the left menu.

![Open API Center instance in Azure portal](../../media/Solution/0407_API_Center_01.png)

1. Select **+ Register an Asset** to create a new **MCP** entry.

1. Fill in the registration details:
   - **Title**: Enter a descriptive name (e.g., "Weather MCP Server")
   - **Asset type**: Select **MCP** from the dropdown
