...
The **Create from Azure OpenAI Service** dialog will appear. Configure the following settings:
...
3. **Display name**: Provide a descriptive name for your API (e.g., "Azure Foundry AI API")
