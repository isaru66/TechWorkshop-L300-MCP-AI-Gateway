...
1. Add additional dimensions for tracking, you can edit the policy by:
...
![Configure API import settings](../../media/Solution/0405_APIM_view_usage_appi_04.png)
...
![Configure API import settings](../../media/Solution/0405_APIM_view_usage_appi_05.png)
