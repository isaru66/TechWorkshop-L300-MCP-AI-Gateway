---
title: '3. Configure load balancing policies'
layout: default
nav_order: 3
parent: 'Exercise 04: Configure AI Gateway using Azure API Management'
---

# Task 02 - Configure load balancing policies

## Introduction

To ensure high availability and optimal performance, you need to configure load balancing across multiple AI backend endpoints. This task focuses on implementing intelligent routing strategies that distribute AI API traffic effectively.

## Description

In this task, you will configure load balancing policies in Azure API Management to distribute traffic across multiple Azure OpenAI endpoints. You'll implement round-robin, weighted, and priority-based routing strategies to optimize AI service availability.

## Success Criteria

- You have configured a backend pool with multiple AI endpoints.
- You have implemented load balancing with at least one routing strategy.
- You have tested failover behavior when a backend is unavailable.
