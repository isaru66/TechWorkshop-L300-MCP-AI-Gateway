---
title: '4. Configure authentication and security policies'
layout: default
nav_order: 4
parent: 'Exercise 04: Configure AI Gateway using Azure API Management'
---

# Task 03 - Configure authentication and security policies

## Introduction

Securing your AI Gateway is critical to ensure that only authorized users and applications can access your AI services. In this task, you'll implement authentication and authorization policies that enforce a zero-trust security model.

## Description

In this task, you will configure authentication policies in Azure API Management, including API key validation, OAuth 2.0, and managed identity integration. You'll also implement request filtering and content validation to prevent malicious inputs.

## Success Criteria

- You have configured API key authentication for AI endpoints.
- You have implemented OAuth 2.0 or managed identity authentication.
- You have applied input validation policies to prevent injection attacks.
