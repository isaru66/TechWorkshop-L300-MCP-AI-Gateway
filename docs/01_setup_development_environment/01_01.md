...
2. Open Repository [https://github.com/isaru66/TechWorkshop-L300-MCP-AI-Gateway](https://github.com/isaru66/TechWorkshop-L300-MCP-AI-Gateway).
3. Select the **Code** button. 
4. Select the **Codespaces** tab and choose **Create codespace on main**.
