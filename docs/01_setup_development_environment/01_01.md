...
Fork [this GitHub repository](https://github.com/microsoft/TechWorkshop-L300-MCP-AI-Gateway) to your account. You will need to fork the repo in order to modify and use GitHub Actions workflows in later exercises.
