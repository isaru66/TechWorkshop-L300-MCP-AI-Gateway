...
You will also receive access to **GitHub Copilot Enterprise (GHE)**, which provides access to advanced AI models to accelerate troubleshooting and development during the training. Available models include GPT-5.2-Codex, Claude Sonnet 4.5, Gemini 2.5 Pro, and more.
...
After signing in to GitHub with SSO, configure VS Code/Codespace to use GitHub Copilot Enterprise.
